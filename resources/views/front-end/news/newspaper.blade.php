            ...
            <div class="row">
                ...
                <div class="col-12 col-md-2">
                    <div class="wrapper">
                        ...
                        <nav id="sidebar"
                             class="bg-transparent text-dark custom-news-nav-header-top " style="width: 235px; margin-top: 150px;">
        ...
        var example2 = new Vue({
            ...
            methods: {
                ...
                call() {
                    ...
                    let url = '/api/news/newspaper/last_id/' + this.last_id + '/' + {{$newspaper->id}};
                    //console.log(url);
                    fetch(url, {
